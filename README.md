...
1. Download whole package ("Clone or Download" > "Download ZIP")<br>
  2. Extract all files from the <u>/bin</u> folder into your local Grasshopper/Library folder (usually in 'C:\Users\<your-user-name>\AppData\Roaming\Grasshopper\Libraries\'). You can make a subfolder in there if you want, but make sure that all files sit in the same directory.<br>
