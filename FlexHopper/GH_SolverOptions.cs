...
namespace FlexHopper
{
    public class GH_SolverOptions : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if(memq.Count != 9)
            {
                memq = new List<int> { 131072, 96, 65536, 65536, 65536, 65536, 65536, 196608, 131972 };
                if (memq.Count != 0)
                    AddRuntimeMessage(GH_RuntimeMessageLevel.Warning, "Memq input not valid. Must contain nine integers. Defaults were used.");
            }
